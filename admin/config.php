<?php
    ...
    define( 'K_DB_NAME', 'db650064108' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'dbo650064108' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'nature72' );
    // 7.
    // MySQL hostname (it will usually be 'localhost')
    define( 'K_DB_HOST', 'db650064108.db.1and1.com' );
    // 7b.
    ...
    define( 'K_EMAIL_TO', 'callcleanbynature@gmail.com' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'contact@cleanbynature.com' );
